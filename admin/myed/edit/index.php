<?php
    ...
    if(isset($_POST['update'])) {
        ...
        if(empty($pwd1)) {
            $query = "UPDATE myed SET schoolname = '$schoolname', username = '$username', email = '$email', contact='$contact', db_name='$dbname' WHERE id='$id'";
            ...
            if($pwd1 == $pwd2 && $pwd1 != null) {
                $pwd = md5($pwd1);
                $query = "UPDATE user SET schoolname = '$schoolname', username = '$username', email = '$email', contact='$contact', db_name='$dbname', password = '$pwd' WHERE id='$id'";
                mysqli_query($conn,$query);
                $msg = "User details have been updated!!";
                echo "<script>window.location = '../../myed/".$msg."'</script>";
            } else {
    ...
    $sql = "SELECT * FROM myed WHERE id = '$id'";
                        ...
                        <div class="card-body">
                            <form method="post">
                                <div class="position-relative form-group">
                                    ...
                                    <input type="text" name="schoolname" id="schoolname" value="<?php echo $data['schoolname'] ?>" class="form-control" required />
                                </div>
                                <div class="position-relative form-group">
                                ...
                                <div class="position-relative form-group">
                                    ...
                                    <input type="text" name="contact" id="contact" value="<?php echo $data['contact'] ?>" class="form-control" required />
                                </div>
                                <div class="position-relative form-group">
                                    <label for="dbname" class="">Database Name</label>
                                    <input type="text" name="dbname" id="dbname" value="<?php echo $data['db_name'] ?>" class="form-control" required />
                                </div>
                                <div class="position-relative form-group">
