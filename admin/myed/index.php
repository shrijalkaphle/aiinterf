        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <h5 class="card-header">List of MYED Users</h5>
                                ...
                                <div class="card-body">
                                    <form class="">
                                        <div class="position-relative form-group">
                                            <label for="name" class="">School Name</label>
                                        ...
                                        <div class="position-relative form-group">
                                            <label for="database" class="">Database Name</label>
                                            <input type="text" name="database" id="database" placeholder="Enter Database Name" class="form-control" required />
                                        </div>
                                        <div class="position-relative form-group">
